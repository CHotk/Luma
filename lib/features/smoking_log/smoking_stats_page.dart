...
class SmokingStatsPage extends ConsumerStatefulWidget {
  const SmokingStatsPage({super.key});

  @override
  ConsumerState<SmokingStatsPage> createState() => _SmokingStatsPageState();
}

class _SmokingStatsPageState extends ConsumerState<SmokingStatsPage> {
  late final Future<List<SmokingEntry>> _future = ref
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      children: [
        Row(
          children: [
            Expanded(child: _statCard('今天', '$today 根', AppColors.mid)),
