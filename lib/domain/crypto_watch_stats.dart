import 'models/crypto_watch_entry.dart';
...
/// 每天看幾次。
Map<DateTime, int> countsByDay(List<CryptoWatchEntry> entries) {
...
Duration? averageInterval(List<CryptoWatchEntry> entries, DateTime since) {
  final times =
...
Map<String, int> countsByBucket(List<CryptoWatchEntry> entries) {
...
/// 觸發原因次數（沒填的歸「未填」）。
Map<String, int> countsByReason(List<CryptoWatchEntry> entries) {
