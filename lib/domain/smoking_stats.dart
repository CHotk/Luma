...
/// 每天看幾次。
Map<DateTime, int> countsByDay(List<SmokingEntry> entries) {
...
Duration? averageInterval(List<SmokingEntry> entries, DateTime since) {
  final times =
...
Map<String, int> countsByBucket(List<SmokingEntry> entries) {
...
/// 觸發原因次數（沒填的歸「未填」）。
Map<String, int> countsByReason(List<SmokingEntry> entries) {
